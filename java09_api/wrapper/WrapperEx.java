...
public class WrapperEx {
	public static void main(String[] args) {
		...
		Byte bVal = new Byte((byte)1); //강제 형변환
		short sVal;
		Long lVal;
		...
		Integer iVal3 = new Integer("123"); //박싱
		...
		double d1 = 123.456; //기본 데이터 타입 double
		
		Double dVal1 = new Double(d1); //박싱 , Boxing
		Double dVal2 = new Double("46.543"); //박싱 , 
...
//		System.out.println(num2);
		...
		String data = "true";
//		String data = "1231254124"; false
//		String data = "false"; false
		boolean b = Boolean.parseBoolean(data);
		System.out.println(b);
		

		// Charcter.parseChar(String) 이런 메소드는 존재하지 않는다
		// 파싱은 아니지만 문자열에서 단일문자(char)데이터를 분리할때
